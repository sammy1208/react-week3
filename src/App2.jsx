...
function App() {
  ...
  //   try {
  //     const res =await axios.get(`${BASE_URL}/v2/api/${API_PATH}/admin/products`)
  //     const Project = res.data.products.map((res) =>{
  //       console.log(res)
  //     })
  //   } catch (error) {
  //     console.log(err)
                ...
                <div className="col-md-8">
                  ...
                  <div className="mb-3">
                    ...
                    {/* <textarea
                      ...
                      placeholder="請輸入說明內容"
                    ></textarea> */}
                    <p>{tempProduct.content.introduce}</p>
                    <hr/>
                    <ul>
                    {tempProduct.content.project &&
                      tempProduct.content.project.map((item, index) => (
                        <li key={index}>{item}</li>
                      ))}
                    </ul>
                    <hr/>
                    <ul>
                    {tempProduct.content.Specification &&
                      tempProduct.content.Specification.map((item, index) => (
                        <li key={index}>{item}</li>
                      ))}
                    </ul>
